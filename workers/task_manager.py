...
class TaskManager:
    ...
    def __init__(self, job_id, task_id, s3_keys):
        self.s3_keys = s3_keys
        self.input_files_dir = f'{self.temp_output_dir}/jobs/{job_id}/tasks/{task_id}/inputs'
        self.output_file_path = f'{self.temp_output_dir}/jobs/{job_id}/tasks/{task_id}/output.{FILE_EXTENSION}'
        self.output_file_s3_key = f'data/jobs/{job_id}/tasks/{task_id}/output.{FILE_EXTENSION}'

    def process(self):
        # Call backend: Task started
